/*
  # Update 4.5kg Events Product with Minimalist Description

  1. Changes
    - Remove all hashtags and markdown formatting
    - Create clean, minimalist text layout
    - Maintain professional tone with elegant simplicity
    - Preserve all important information in clean format
*/

-- Update the 4.5kg Events product with clean, minimalist description
UPDATE products 
SET 
...
• Fitile MICI - Ideale pentru vaze cu diametrul de 8 cm sau mai mari
• Fitile MEDII - Recomandate pentru vaze cu diametrul de 10 cm și mai mari  
• Fitile MARI - Potrivite pentru vaze cu diametrul de 13 cm și mai mari
