/*
  # Update Wick Types to Vertical Format

  1. Changes
    - Format the wick types (MICI, MEDII, MARI) in vertical rows
    - Clean, minimalist presentation
    - Easy to read enumeration format

  2. Updates
    - Modify the long_description for the 4.5kg events product
    - Keep all other content the same
    - Focus on vertical alignment of wick specifications
*/

-- Update the 4.5kg Events product with vertical wick format
UPDATE products 
SET 
