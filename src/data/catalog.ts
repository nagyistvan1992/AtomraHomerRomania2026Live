...
export const catalogProducts: CatalogProduct[] = [
  {
    ...
    tags: ['Bestseller', 'Eco-Friendly', 'Gift Ready', 'Natural', 'lumanari perlate', 'lumanare naturala din ceara', 'idei cadou lumanare', 'lumanare perlata cadou'],
    in_stock: true,
  ...
  },
  {
    ...
    tags: ['Essential', 'Elegant', 'Minimal', 'Relaxing', 'lumanari perlate', 'lumanare naturala din ceara', 'idei cadou lumanare', 'lumanare perlata cadou'],
    in_stock: true,
  ...
  },
  {
    ...
    tags: ['Premium', 'Versatile', 'Sophisticated', 'Special Moments', 'lumanari perlate', 'lumanare naturala din ceara', 'idei cadou lumanare', 'lumanare perlata cadou'],
    in_stock: true,
