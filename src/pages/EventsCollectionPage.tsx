            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
              ...
              >
                ...
                <p className="text-lg text-slate-600 max-w-2xl mx-auto font-light leading-relaxed">
                  Perfecte pentru ocazii speciale și momente memorabile. Creează atmosfera ideală pentru orice sărbătoare cu colecțiile noastre pentru evenimente.
                </p>
              </motion.div>
            </div>
          </section>
                      ...
                      >
                        <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 h-full flex flex-col border border-slate-100">
                          ...
                          >
                            ...
                            {/* Tag for special offers or featured products */}
                            {product.tags && product.tags.includes('Sale') && (
                              <div className="absolute top-3 right-3 bg-amber-100 text-amber-800 text-xs py-1 px-2 rounded-md font-light">
                                Ofertă specială
                              </div>
                            )}
