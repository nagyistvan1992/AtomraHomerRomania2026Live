...
const translations: Record<Language, Record<string, string>> = {
  ro: {
    ...
    'categories.title': 'Seturi cadou și rezerve de ceară perlată',
    'categories.subtitle': 'Descoperă ceara nisip albă, rezervele naturale și produsele noastre elegante pentru casă și evenimente.',
    'categories.home.title': 'Acasă',
    'categories.home.description': 'Piese decorative elegante pentru living, dining și dormitor.',
    'categories.events.title': 'Evenimente',
    'categories.events.description': 'Aranjamente flexibile pentru nunți, botezuri și mese festive.',
    'categories.accessories.title': 'Accesorii',
    'categories.accessories.description': 'Fitiluri premium și recipiente speciale pentru ceară perlată.',
    'categories.coming.title': 'În curând',
    'categories.coming.description': 'Colecții noi și seturi cadou în ediție limitată.',

    'howItWorks.title': 'Cum funcționează lumânările reîncărcabile Atomra?',
    'howItWorks.subtitle': 'Simplu, curat, hipoalergenic și ușor de adaptat oricărui recipient.',
    'howItWorks.pour.title': 'Umple',
    'howItWorks.pour.description': 'Adaugă perlele de ceară nisip în recipientul tău favorit.',
    'howItWorks.insert.title': 'Inserează',
    'howItWorks.insert.description': 'Poziționează fitilul din bumbac în centru.',
    'howItWorks.light.title': 'Aprinde',
    'howItWorks.light.description': 'Bucură-te de o ardere curată, fără fum și fără parfum sintetic.',
    'howItWorks.refresh.title': 'Reîmprospătează',
    'howItWorks.refresh.description': 'Schimbă fitilul sau completează ceara perlată pentru o lumânare ca nouă.',

    'whyAtomra.title': 'De ce să alegi ceara nisip albă fără parfum?',
    'whyAtomra.subtitle': '100% Ceară Naturală & Hipoalergenică - Soluții elegante pentru casă și evenimente.',
    'whyAtomra.refillable.title': '100% Ceară Naturală & Hipoalergenică',
    'whyAtomra.refillable.description': 'Ardere curată, fără parfum, ideală pentru mese festive és persoane sensibile.',
    'whyAtomra.eco.title': 'Lumânări Reîncărcabile & Rezerve',
    'whyAtomra.eco.description': 'Reutilizezi recipientele preferate la nesfârșit adăugând ceară granulată.',
    'whyAtomra.customize.title': 'Soluții elegante pentru casă și evenimente',
    'whyAtomra.customize.description': 'Creează decoruri de vis pentru living, terasă, nunți vagy cine romantice.',
