...
> = {
  ro: {
    ...
    rights: `© ${new Date().getFullYear()} Atomra Home Romania. Toate drepturile rezervate.`,
  ...
  hu: {
    ...
    rights: `© ${new Date().getFullYear()} Atomra Home Romania. Minden jog fenntartva.`,
  ...
  en: {
    ...
    rights: `© ${new Date().getFullYear()} Atomra Home Romania. All rights reserved.`,
